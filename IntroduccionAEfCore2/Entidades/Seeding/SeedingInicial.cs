using IntroduccionAEfCore2.Entidades.Configuraciones;
using Microsoft.EntityFrameworkCore;

namespace IntroduccionAEfCore2.Entidades.Seeding
{
    public class SeedingInicial
    {
        public static void Seed(ModelBuilder builder)
        {
            ...
            builder.Entity<Actor>().HasData(samuelLJackson, RobertDowneyJunior);
            ...
            builder.Entity<Pelicula>().HasData(avengers, spiderManNWH, spiderManSpiderVerse2);
            ...
            builder.Entity<Comentario>().HasData(comentarioAvengers, comentarioAvengers2, comentarioNWH);
            ...
            builder.Entity(tablaGeneroPelicula).HasData(
            ...
            builder.Entity<PeliculaActor>().HasData
                (
